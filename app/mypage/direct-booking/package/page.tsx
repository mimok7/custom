...
function PackageBookingContent() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            localStorage.setItem(getDraftStorageKey(quoteId, 'package'), JSON.stringify(draftEnvelope));
            alert(`패키지 입력 내용이 임시 저장되었습니다.\n예상 총액: ${calculatedTotalPrice.toLocaleString()}동\n상단 \"전체 예약 신청\" 버튼으로 최종 신청해 주세요.`);
